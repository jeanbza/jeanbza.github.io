...
When I worked on ObjFS at Google, I worked with a few peers who I can
confidently say were C++ legends (hiya Matt, Frank, Sarah, Riba, Ambrose, and
co). A few of them were easy to get into deep discussions about Computer
Science, and I'd come away an hour or two later knowing far more than I'd
started in the conversation. This is one of my biggest joys working with highly
skilled colleagues.

A few times during these conversations, after spending a while talking about
something very deep in the weeds, one of them would mention that this was a lot
easier to reason about if you'd written one of these deep-in-the-weeds things
before.

I had several opportunities to do some version of that just by working on ObjFS,
but I recently decided that I wanted to better understand the heap/stack/memory
allocation. So, I built an allocator as a learning experience. I also figured
out how to use ImHex to look at the bytes being allocated, which was a really
helpful exercise in making the ideas stick. This article series details the
building of that allocator and how you too can look at bytes and go, "Ahh right,
