...
categories: [go, tooling]
description: "Running pkgsite yourself against a private enterprise GitHub and goproxy."
toc: true
---
...
it only hosts documentation for a single repo. So, we'll move on from this.
...
Note: If you're using `github.com/jeanbza/golang-index`, the index runs (as of
